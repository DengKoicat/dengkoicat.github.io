...
> Answer the given question. You must conduct reasoning inside <span style="color:#00AEEF">&lt;think&gt;</span> and <span style="color:#00AEEF">&lt;/think&gt;</span> first every time you get new information. After reasoning, if you find you lack some knowledge, you can call a search engine by <font color="#1E90FF">&lt;search&gt;</font> query <font color="#1E90FF">&lt;/search&gt;</font>, and it will return the top searched results between <font color="#D4A017">&lt;information&gt;</font> and <font color="#D4A017">&lt;/information&gt;</font>. You can search as many times as you want. If you find no further external knowledge needed, you can directly provide the answer inside <font color="#D32F2F">&lt;answer&gt;</font> and <font color="#D32F2F">&lt;/answer&gt;</font> without detailed illustrations. For example, <font color="#D32F2F">&lt;answer&gt;</font> xxx <font color="#D32F2F">&lt;/answer&gt;</font>. Question: <span style="color:#7CFC00">question</span>.
### Objective Function
